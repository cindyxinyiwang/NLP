...
p = 0.200086480861
n = 4.88137405883
line_neg_binomial, = plt.plot(x, nbinom.pmf(x, n, p), ls=":", linewidth=2)
...
plt.legend([line_lognorm, line_gram, real_plt, line_neg_binomial], [ 'lognormal',  'grammar', 'Treebank data', 'Negative Binomial'])
plt.show()
